...
const ContactUs = () => {
  ...
  return (
    ...
    <Header/>
     <Head>
        <title>Contact Us | CodeCatalysts</title>
        <meta name="description" content="Get in touch with Codecatalysts for any inquiries, feedback, or support." />
        <meta name="keywords" content="contact, customer support, AI courses" />
        <link rel="canonical" href="https://sayandip.framer.website/" />
      </Head>
