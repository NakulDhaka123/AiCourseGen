    ...
    <div className="p-6 border rounded-xl shadow-md mt-3">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
        <div className="flex gap-2">
          ...
          <div>
            <h2 className="text-xs text-white">Skill Level </h2>
        ...
        <div className="flex gap-2">
          ...
          <div>
            <h2 className="text-xs text-white">Duration </h2>
        ...
        <div className="flex gap-2">
          ...
          <div>
            <h2 className="text-xs text-white">No of Chapter </h2>
        ...
        <div className="flex gap-2">
          ...
          <div>
            <h2 className="text-xs text-white">Include Video </h2>
