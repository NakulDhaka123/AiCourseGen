  ...
  return (
    <>
     <Head>
        ...
        <meta name="author" content="CodeCatalysts" />
    ...
    <div className="flex items-center gap-2">
      <Link href={'/'} className="flex justify-center items-center gap-2">
        ...
        <span className="font-bold text-xl bg-gradient-to-r from-violet-500 via-pink-500 to-purple-500 bg-clip-text text-transparent">
          CodeCatalysts
        </span>
      </Link>
    </div>
      <div className="flex justify-center items-center gap-10 cursor-pointer">
       <Link href={"https://github.com/Sayandip-Jana-1018" }>
         <RxGithubLogo className="text-3xl"/>
       </Link>          
      <Link href={'/dashboard'} >

      <Button variant="startButton" >Let's Ignite</Button>
      </Link>
      </div>
    </div>
    </>
