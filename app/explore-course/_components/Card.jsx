...
const Card = ({ course, refreshData }) => {
  ...
  return (
    <div className="shadow-lg transition-transform duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-slate-100 relative overflow-hidden rounded-md cursor-pointer border border-transparent hover:border-primary">
