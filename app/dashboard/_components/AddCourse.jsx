...
const Addcourse = () => {
  ...
  const isAdmin = user?.primaryEmailAddress?.emailAddress == 'jsupriti3434@gmail.com';
  ...
  return (
    <div  className='flex justify-between items-center'>
        <div>
            ...
            <p className='text-sm text-white'>Create new course with Ai, Share with friends and Earn form it.</p>
        </div>
